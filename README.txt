...
The python program modi_cloud.py generates the word cloud that is word_cloud.png.

The python program modi_frequency.py generates the word frequency that is word_frequency.png.
